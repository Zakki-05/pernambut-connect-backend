...
from .views import (
    RegisterAPIView, VerifyOTPAPIView, ResendOTPAPIView, LoginAPIView, LogoutAPIView, ProfileAPIView, UpdateLanguageAPIView,
...
urlpatterns = [
    ...
    path('update-language/', UpdateLanguageAPIView.as_view(), name='update_language'),
